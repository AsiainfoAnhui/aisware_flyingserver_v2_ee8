...
- [x] Public URL of TCK Results Summary:<br/>
  [microprofile-jwt-auth-1.2 TCK Result](https://github.com/AsiainfoAnhui/aisware_flyingserver_v2_ee8/blob/master/MicroProfile/TCK_result/mp4.1/microprofile-jwt-auth-1.2/TCK_Result.MD)
